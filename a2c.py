...
class ActorCriticAgent():
    ...
    def training_actor(self, S, A, TD_error):
    ...
    def training_critic(self, S, S_next, R, terminal):
        ...
        with GradientTape() as gt:
            ...
            TD_error = bootstrapping - value_S
        ...
        return TD_error # for updating actor
...
def main():
    ...
    for episode in range(EPISODES):
        ...
        while True:
            ...
            TD_error = ac_agent.training_critic(S, S_next, R, terminal)
            ac_agent.training_actor(S, A, TD_error)
            S = S_next
            total_R += R
